...
- Restaurar a base utilizando o backup "LojaDb.bak" ou criar o banco manualmente com o nome: "LojaDb" e executar o scritp contido no arquivo: "script-loja-db.sql" que encontra-se na raiz do projeto;
